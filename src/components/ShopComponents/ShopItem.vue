<template>
    <RouterLink :to="'/article/'+item.normalized" >
        <div :style="{height: longDisplay ? '150px' : 'initial'}" :class="['bg-white d-flex w-100', {'flex-column shopItemCard':!longDisplay}]">
            ...
            <div v-if="!hideDescription" :style="{minWidth: longDisplay ? '140px' : 'initial'}" :class="['d-flex flex-column justify-content-center', longDisplay ? 'text-left mr-auto px-md-4 pl-2' : 'text-center m-auto']">
