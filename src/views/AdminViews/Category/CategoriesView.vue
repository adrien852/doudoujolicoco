<template>
    ...
    <div class="container position-relative mt-2">
        ...
        <div class="mb-3">
            ...
            <RouterLink class="position-relative ml-2" to="/admin/categories/nouveau"><button id="deleteButton" class="btn btn-primary">Nouveau</button></RouterLink>
        </div>
        <div ref="inventoryContainer" class="d-flex flex-column w-100">
            ...
            <CategoryTable @itemIdDeleted="removeItem" :items="paginatedItems" :tableHeaders="tableHeaders"/>
            <vue-paginate v-if="pageCount > 1" class="row mx-auto"
                v-model="page" :page-count="pageCount" :active-class="'active'" :containerClass="'pagination'" :prev-text="'<'" :next-text="'>'" :click-handler="clickCallback">
            </vue-paginate>
        </div> 
...
<script setup>
    import CategoryTable from '@/components/AdminComponents/CategoryComponents/CategoryTable.vue'
    import { onMounted, reactive } from 'vue';
    import Loading from 'vue3-loading-overlay';
    import 'vue3-loading-overlay/dist/vue3-loading-overlay.css';
    import {getCategories} from '@/services/InventoryService.js'
